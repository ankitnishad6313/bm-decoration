        ...
        <div class="bg-secondary rounded p-4">
            <div class="row g-4">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <h6 class="mb-0">Edit Addon</h6>
                    <div>
                        <a class="btn btn-outline-primary me-1" href="{{ route('addon-create') }}">Create New Addon</a>
                        <a class="btn btn-outline-primary ms-1" href="{{ route('addon-list') }}">All Addon</a>
                    </div>
                </div>
                <hr>
                ...
                <div class="col-12">
                    <div class="bg-secondary rounded h-100 px-4">
                        <div class="row g-4">
                            <form class="row" action="{{ route('addon-update', ['id' => $data->id]) }}" method="POST"
