    ...
    <div class="container">
        ...
        <div class="details">
            <div class="personal-information">
                ...
                <form action="{{ route('user-update-rofile') }}" method="post" class="details-form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-fields">
                        <label for="alternate_phone">Alternate Phone/Mobile*</label>
                        <input type="number" name="alternate_phone" id="alternate_phone" value="{{ old('alternate_phone', $user->alternate_phone) }}" required />
                    </div>
                    ...
                    <div class="input-fields">
                        ...
                        <input type="text" name="pincode" id="pincode" value="{{ old('pincode', $user->pincode) }}" required />
                    </div>
                    <div class="input-fields">
                        <label for="current_address">Current Address</label>
                        <input type="text" name="current_address" id="current_address" value="{{ old('current_address', $user->current_address) }}" required />
                    </div>
                   
                    <div class="input-fields">
                        <label for="permanent_address">Permanent Address*</label>
                        <input type="text" name="permanent_address" value="{{ old('permanent_address', $user->permanent_address) }}" required />
                    </div>
                    
                    <button class="saveBtn" type="submit" name="add">Save Changes</button>
                </form>
            </div>
        </div>
    </div>
